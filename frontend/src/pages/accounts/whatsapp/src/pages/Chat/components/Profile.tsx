  ...
  return (
    <div className='profile'>
      ...
      <ul className='profile__section profile__section--actions'>
        ...
        <li className='profile__action'>
          <p className='profile__action-left'>
            <span className='profile__action-text profile__action-text--top'>Starred Messages</span>
          </p>
        ...
        <li className='profile__action'>
          <p className='profile__action-left'>
            ...
            <span className='profile__action-text profile__action-text--bottom'>Off</span>
          </p>
          <button className='profile__action-right'>
            <Icon id='rightArrow' className='profile__heading-icon' />{' '}
          </button>
        ...
        {groups.map((group) => (
          <div className='profile__group' key={group.name}>
            ...
            <div className='profile__group-content'>
              <p className='profile__group-text profile__group-text--top'>{group.name}</p>
              <p className='profile__group-text profile__group-text--bottom'>{group.members}</p>
            </div>
          </div>
        ))}
      </div>
